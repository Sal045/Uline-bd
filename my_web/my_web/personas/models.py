...
class Evaluacion(models.Model):
    usuario = models.ForeignKey('Usuario',  null=True, blank=False, related_name='evaluacion_de_los_usario', on_delete=models.CASCADE)
    curso = models.ForeignKey('Curso', null=True, blank=False, related_name='evaluaciones_de_curso', on_delete=models.CASCADE)
    periodo = models.TimeField(auto_now=False, auto_now_add=False)
    calificacion = models.DecimalField(max_digits=5, decimal_places=2)
...
class Usuario(models.Model):
    ...
    rol = models.CharField(max_length=2, blank=True, choices=FIELD_X)
...
class Inscripcion(models.Model):
    usuario1 = models.ForeignKey('Usuario',  null=True, blank=False, related_name='inscripciones_de_los_usario', on_delete=models.CASCADE)
    curso1 = models.ForeignKey('Curso',  null=True, blank=False, related_name='inscripciones_al_curso', on_delete=models.CASCADE)
    fecha_de_inscripcion= models.DateTimeField(auto_now_add=True)
